...
docker run --rm --network host \
  ...
  ghcr.io/dubcodes/kairix-opsbook:0.1.18 \
...
The GitHub Actions workflow publishes both `ghcr.io/dubcodes/kairix-opsbook:latest` and a versioned tag such as `ghcr.io/dubcodes/kairix-opsbook:0.1.18` on pushes to `main`.
