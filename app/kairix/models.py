...
class DeviceStatSnapshot(Base):
    ...
    docker_running_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
    docker_stopped_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
    docker_unhealthy_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
    docker_total_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
